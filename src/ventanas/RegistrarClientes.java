...
public class RegistrarClientes extends javax.swing.JFrame {
    ...
    public RegistrarClientes() {
        ...
        setSize(530, 430);
        setResizable(false);
        setTitle("Registrar Cliente - Sesion de " + user);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(355, 200, -1, -1));
        ...
        getContentPane().add(registrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 100, 120, 100));
