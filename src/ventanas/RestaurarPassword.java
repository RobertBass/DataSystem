...
public class RestaurarPassword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton_RestaurarPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 210, 35));
        ...
        if (!password.equals("") && !confirmacion_password.equals("")) {
            if (password.equals(confirmacion_password)) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Restauración de Password exitosa");
                    this.dispose();
                ...
                JOptionPane.showMessageDialog(null, "La confirmación es incorrecta");
            }
