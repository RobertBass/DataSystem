...
public class Informacion_Cliente extends javax.swing.JFrame {
        ...
        jTable_equipos.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                ...
                if (fila_point > -1) {
                    ...
                    InformacionEquipo info_equipo = new InformacionEquipo();
                    info_equipo.setVisible(true);
    ...
    private void initComponents() {
        ...
        jLabel_modificado = new javax.swing.JLabel();
        ...
        jLabel_modificado.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel_modificado.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_modificado.setText("Ultima Modificacion:");
        getContentPane().add(jLabel_modificado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, -1, -1));
        ...
        getContentPane().add(jButton_imprimir, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 260, 120, 100));

        jLabel_footer.setFont(new java.awt.Font("Arial", 3, 18)); // NOI18N
        jLabel_footer.setText("Creado por Robert - Bass ®");
        getContentPane().add(jLabel_footer, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 380, -1, -1));
    ...
    private void jButton_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_actualizarActionPerformed
        ...
        if (validacion == 0) {
            ...
            try {
                ...
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement("update clientes set nombre_cliente = ?, email_cliente = ?, telefono_cliente = ?, direccion_cliente = ?, ultima_modificacion = ? where id_cliente = '" + IdCliente_update + "'");
                ...
                JOptionPane.showMessageDialog(null, "Error al actualizar la informacion del cliente, contacta al Administrador");
            }
    ...
    private void jButton_imprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_imprimirActionPerformed
        ...
        try {
            ...
            parrafo.setFont(FontFactory.getFont("Calibri", 14, Font.BOLD, BaseColor.DARK_GRAY));
            ...
            try {
                ...
                try {
                    ...
                    System.err.print("Error al obtener los datos de los equipos del cliente");
                    
                }
                
            } catch (SQLException e) {
                
                System.err.print("Error al obtener los datos del cliente");
            }
            ...
            JOptionPane.showMessageDialog(null, "Error al generar archivo PDF, contacte al Administrador del Sistema");
    ...
    private javax.swing.JLabel jLabel_modificado;
